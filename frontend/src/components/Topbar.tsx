...
const pageTitles: Record<string, string> = {
  ...
  '/command-center': 'Command Operations Center',
  ...
  '/decision-center': 'Strategy & Decision Operations',
  '/simulator': 'What-If Simulator',
  '/strategy-comparison': 'Strategy Benchmark',
  '/knowledge-base': 'Playbook & Rules KB',
  '/agent-control': 'Automation & Rules Control',
...
const pageSubtitles: Record<string, string> = {
  '/dashboard': 'Overview of your recovered revenue and active cases',
